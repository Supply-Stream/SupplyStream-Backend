...
(0, dotenv_1.config)();
async function getOneEvents(containerID) {
    ...
    try {
        let oneLineResp = await axios_1.default.request(config);
        let cop_no = oneLineResp.data.list[0].copNo;
        // Get the events
        let data2 = qs_1.default.stringify({
            f_cmd: "125",
            cop_no: cop_no,
        });
        let config2 = {
        ...
        let oneEvents = await axios_1.default.request(config2);
...
exports.default = getOneEvents;
//# sourceMappingURL=one-events.js.map